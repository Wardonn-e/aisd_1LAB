...
int main() {
    ...
    Point<complex<double>> c1(complex<double>(0, -12), complex<double>(0, 4));
    Point<complex<double>> c2(complex<double>(30, 22), complex<double>(11, 40));
    cout<<c2<<endl;
    

    BrokenLine<complex<double>> lineRange1(3, c1, c2);
    BrokenLine<complex<double>> lineRange2(lineRange1);
    cout<< lineRange2 << endl;
    
    cout<< lineRange1.len_broken_line()<< endl;
    
    
    if(lineRange1 == lineRange2){
        cout<< 1 << endl;
    }
    else{
        cout<< 0 << endl;
